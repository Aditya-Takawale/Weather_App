...
class WeatherController {
  ...
  async getAirQuality(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const airQuality = await weatherService.getAirQuality(city);
   ...
   */
  async getUVIndex(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   */
  async getMoonData(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
